...
public class AddinganOvalControl {
	public static void main(String[] args) throws Exception {
		...
		// Add an oval shape.
		Oval oval1 = (Oval) excelbook.getWorksheets().get(0).getShapes().addShape(MsoDrawingType.OVAL,
				2, 2, 0, 0, 130, 130);
		...
		Oval oval2 = (Oval) excelbook.getWorksheets().get(0).getShapes().addShape(MsoDrawingType.OVAL,
				9, 2, 0, 0, 130, 130);
